...
#alert {
    position: relative; /* Needed to position the close button absolutely within the alert */
}

#alert .close {
    position: absolute; /* Absolute positioning */
    right: 10px; /* Place it towards the right inside the alert */
    top: 50%; /* Align vertically to the middle */
    transform: translateY(-50%); /* Adjust vertical alignment */
    font-size: 20px; /* Larger close button */
    color: #000; /* Color of the close button, change as needed */
...
textarea#customReason {
    width: 100%; /* Full width */
    height: 100px; /* Set a fixed height */
    padding: 10px; /* Add some padding for text inside textarea */
...
/* Style for focus state to highlight the textarea */
textarea#customReason:focus {
    border-color: #66afe9;
    outline: none;
...
pre[data-line] .line-highlight {
    background: rgba(255, 215, 0, 0.3) !important; /* Light gold highlight */
}

pre[class*="language-"] {
    background: transparent !important; /* White background */
}
.rotate-up {
